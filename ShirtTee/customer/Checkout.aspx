...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        ...
        <div class="mt-10 mx-4 rounded bg-gray-50 px-6 pt-6 lg:mt-0">
            ...
            <div class="">
                <label for="txtEmail" class="mt-4 mb-2 block text-sm font-medium">Email</label>
                <div class="relative">
                    <asp:TextBox ID="txtEmail" runat="server" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="your.email@gmail.com" TextMode="Email" />
