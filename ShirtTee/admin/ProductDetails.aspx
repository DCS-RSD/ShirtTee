...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow dark:bg-gray-800 p-8">
            ...
            <!-- Header -->
            <div class=" pt-8 pb-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                <%--Title--%>
 ...
 <table class="table-auto min-w-full divide-y divide-gray-200 dark:divide-gray-700 ">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                        ...
                        <td class="whitespace-nowrap py-4 px-6 text-gray-800 dark:text-gray-200">STK0001
                        </td>
                        <td class="whitespace-nowrap py-4 px-6 text-gray-800 dark:text-gray-200">S
                        </td>
                        <td class="whitespace-nowrap py-4 px-6 text-gray-800 dark:text-gray-200">
                            <span class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium border border-gray-200 bg-white text-gray-800 shadow-sm dark:bg-slate-900 dark:border-gray-700 dark:text-white">Blue
                            </span>
                            <span class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium border border-gray-200 bg-white text-gray-800 shadow-sm dark:bg-slate-900 dark:border-gray-700 dark:text-white">White
                            </span>
                        </td>
                        <td class="whitespace-nowrap py-4 px-6 text-gray-800 dark:text-gray-200">100
                        </td>
                    </tr>
                    <%--                                    </ItemTemplate>
                                </asp:ListView>--%>
