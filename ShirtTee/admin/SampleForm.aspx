<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MainAdmin.Master" AutoEventWireup="true" CodeBehind="SampleForm.aspx.cs" Inherits="ShirtTee.admin.SampleForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 
<div class="max-w-4xl mx-auto">
  <!-- Card -->
    <div class="bg-white rounded-xl shadow dark:bg-slate-900 p-8">
        <div class="mb-8">
            <h2 class="text-xl font-bold text-gray-800 dark:text-gray-200">Profile
            </h2>
