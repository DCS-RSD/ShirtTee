                    ...
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
                        ...
                        <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="relative">
                                    <asp:TextBox runat="server" placeholder="Search voucher code" ID="txtSearch"
                        ...
                        <asp:ListView ID="ListView1" DataSourceID="SqlDataSource1" runat="server" DataKeyNames="voucher_ID">
                            ...
                            <ItemTemplate>
                                <tr onclick='<%# Eval("voucher_id", "window.location.href = \"VoucherDetails.aspx?voucher_id={0}\";") %>'
                                    class=" border-y border-gray-200 dark:border-gray-700bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800 cursor-pointer">
                                        ...
                                        <th runat="server" scope="col" class="px-6 py-3 text-start">
                                            <div class="flex items-center gap-x-2">
                                                <asp:LinkButton ID="sortTitle" runat="server"
                                                    class="text-xs font-semibold uppercase tracking-wide text-gray-800 dark:text-gray-200" CommandName="Sort" CommandArgument="voucher_ID">
                             ID
                                                </asp:LinkButton>
                                            </div>
                                        </th>
                                        <th runat="server" scope="col" class="px-6 py-3 text-start">
                                            <div class="flex items-center gap-x-2">
                                                <asp:LinkButton ID="sortDate" runat="server"
                                                    class="text-xs font-semibold uppercase tracking-wide text-gray-800 dark:text-gray-200" CommandName="Sort" CommandArgument="voucher_name">
                             Voucher Code
                                                </asp:LinkButton>
                                            </div>
                                        </th>
                                        <th runat="server" scope="col" class="px-6 py-3 text-start">
                                            <div class="flex items-center gap-x-2">
                                                <asp:LinkButton ID="LinkButton1" runat="server"
                                                    class="text-xs font-semibold uppercase tracking-wide text-gray-800 dark:text-gray-200" CommandName="Sort" CommandArgument="discount_rate">
                             Discount Rate
                                                </asp:LinkButton>
                                            </div>
                                        </th>
                                        <th runat="server" scope="col" class="px-6 py-3 text-start">
                                            <div class="flex items-center gap-x-2">
                                                <asp:LinkButton ID="LinkButton2" runat="server"
                                                    class="text-xs font-semibold uppercase tracking-wide text-gray-800 dark:text-gray-200" CommandName="Sort" CommandArgument="min_spend">
                             Min Spend
                                                </asp:LinkButton>
                                            </div>
                                        </th>
                                        <th runat="server" scope="col" class="px-6 py-3 text-start">
                                            <div class="flex items-center gap-x-2">
                                                <asp:LinkButton ID="LinkButton3" runat="server"
                                                    class="text-xs font-semibold uppercase tracking-wide text-gray-800 dark:text-gray-200" CommandName="Sort" CommandArgument="cap_at">
                             Cap At
                                                </asp:LinkButton>
                                            </div>
                                        </th>
